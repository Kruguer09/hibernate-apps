...
public class AltaEmpleados extends javax.swing.JDialog {
    ...
    private void jBGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBGuardarActionPerformed
        ...
        if (etNumEmp.getText().length() == 0
                || etApellido.getText().length() == 0 || etSalario.getText().length() == 0 || etComision.getText().length() == 0 || etOficio.getText().length() == 0 || cbDepartamentos.getSelectedItem().toString().length() == 0) {
            ...
            Empleados a1=
            a1 = new Empleados(Integer.parseInt(etNumEmp.getText()), etApellido.getText(), etOficio.getText(), calendario.getDate(), salario,comision);
